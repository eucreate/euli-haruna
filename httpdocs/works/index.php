  ...
  <div id="works">
    ...
    <div id="searchForm">
      ...
      ?>
        ...
        <select name="genreName">
          ...
          <option value="all"<?php if (isset($_POST['genreName']) && $_POST['genreName'] === "all" || $selGenreName === "all") echo " selected"; ?>>全て</option>
          <?php
    ...
    <?php
      foreach($worksDigest as $row) {
        echo '<article>'."\n".'<h3><a href="'.$row["works_id"].'.html">'.$row["works_variation_title"]."</a></h3>\n";
